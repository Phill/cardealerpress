	...
	<div id="print-wrapper">
		<div id="detail-print">
			<div class="print-header">
				...
				<div class="print-header-name"><?php echo get_dealer_contact_name( $vehicle['contact_info'], $this->options['vehicle_management_system' ]['custom_contact'], $vehicle['saleclass'] ) ?></div>
				<div class="print-header-phone"><?php echo get_dealer_contact_number( $vehicle['contact_info'], $this->options['vehicle_management_system' ]['custom_contact'], $vehicle['saleclass'] ) ?></div>
			</div>
			<div class="print-top">
				...
				<div class="print-price">
					<?php $price = get_price_display($vehicle['prices'], $this->company, $vehicle['saleclass'], $vehicle['vin'], 'print', $this->options['vehicle_management_system' ]['theme']['price_text'], array() );
						echo
