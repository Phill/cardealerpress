	 ...
	 */
		function get_headers() {
			...
			if( $body ) {
				...
				$this->headers[ 'page_keywords' ] = isset($body->page_keywords) ? $body->page_keywords : '';
				$this->headers[ 'follow' ] = isset($body->follow) ? $body->follow : '';
				$this->headers[ 'index' ] = isset($body->index) ? $body->index : '';
			} else {
				$headers = false;
			}
		}
